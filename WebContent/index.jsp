	...
	<nav>
		<div class="nav-wrapper light-blue accent-3 z-depth-2">
			...
			<ul id="nav-mobile" class="right hide-on-med-and-down">
				<li><a href="logincerto.jsp">Login</a></li>
				<li><a href="logincerto.jsp">Change Password</a></li>
			...
			<div class="col s12 l10">
				<div class="row">
					<div id="cardAdd"
						...
						<form class="col s12" action="addcard">
							<div class="row">
					...
					<div class="col s12 m6 l3">
						<div class="card large <%=nota.getColor() %> lighten-3 z-depth-2"
							...
							<div style="height: 50px;">
								<input name="titulo" placeholder="Adicionar título"
									style="color: black; font-size: 22pt; margin-left:10%; margin-top:5%; border-bottom: none !important;"
									value="<%=nota.getTitulo()%>">
							</div>
							<div class="card-content">
							<div style="height: 100px;">
								<div class="input-field col s12">
									<textarea class="materialize-textarea" name="content"><%=nota.getContent()%></textarea>
								</div>
							</div>
							<% if (tag != null) {
				%>
