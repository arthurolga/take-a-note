    ...
    <div class="row">
      ...
      <div class="col s8 offset-s2 grey lighten-5 z-depth-1 " style="margin-top:-1%; padding-bottom:100%;" >
        <form class="col s12">
          ...
          <div>
                <br>
                <p class="center-align"><font color="red">User does not exist!</font></p>
            </div> 
          ...
          <div class="row">
            ...
            <div class="input-field col s8 offset-s2">
              Username:<input id="username" type="text" class="validate" name='nome'>
            </div>
  
        </div>
        <div class="row">
          <div class="input-field col s8 offset-s2">
            Senha:<input id="password" type="password" class="validate" name='senha'>
