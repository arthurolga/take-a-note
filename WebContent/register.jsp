        ...
        <form class="col s12">
          ...
          <div class="row">
            ...
            <div class="input-field col s8 offset-s2">
             Username: <input id="username" type="text" class="validate" required="" aria-required="true" name='nome'>
              </div>
  
        </div>
        <div class="row">
          <div class="input-field col s8 offset-s2">
           Senha: <input  id="password" type="password" class="validate" required="" aria-required="true"  name='senha'>
